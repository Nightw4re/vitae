...
const MINECRAFT_DEPENDENT = [
    ...
    'VitaeTestEntity.java',
    'VitaeEffectHooks.java',
    'VitaeEffectProvider.java',
    'VanillaEffects.java',
    'ExternalSpellExecutor.java',
    'ExternalSpellBridge.java',
    'SpinSlashExecutor.java',
    'SpawnEntityExecutor.java',
    'PlaceBlockExecutor.java',
    'LevitateTargetExecutor.java',
    'VitaeDemoSpawnEggItem.java',
    'VitaeDemoSpawnerBlock.java',
    'VitaeDemoSpawnerBlockEntity.java',
    'VitaeDemoCommand.java',
    'VitaeDemoEntityRenderer.java',
    'VitaeDemoClient.java',
    'VitaeContent.java',
];
